		...
		<section class="pt-100 pb-70" data-scroll-index="1">
			...
			<div class="container">
				<div class="section-title text-center" data-aos="fade" data-aos-duration="400" data-aos-delay="400">
					...
					<h2>B.E.T POLYTECHNIC</h2>
					<p class="sub">Bharathinagara(K M Doddi,Maddur Taluk,Mandya)</p>
					<h5>1st Sem,Electronics and Communication Engineering.2023-2024</h5>
				</div>

				<div class="container mt-5">
					<h1>C Programming Assignment Marks</h1>
					...
					<div class="container">
						<div class="row">
							<div class="col">
								...
								WHERE semester = 1 and department='ECE'
								...
								if ($result->num_rows > 0) {
									...
									while ($row = $result->fetch_assoc()) {
										$nameColor = ($row['status'] == 'Submitted') ? 'style="color: green;"' : 'style="color: red;"';
				...
				<div class="container mt-5">
					<h1>Python Programming Assignment Marks</h1>
					...
					<div class="container">
						<div class="row">
							<div class="col">
								...
								// Query database for user data
								$query = "SELECT * FROM StudentAssignments where semester=5 and department='ECE' ORDER BY student_name ASC";
								$result = $conn->query($query);
